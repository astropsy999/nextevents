const DUMMY_EVENTS = [
    {
      id: 'e1',
      title: 'Програмування для кожного',
      description:
    ...
    {
      id: 'e3',
      title: 'Програмування у великих масштабах',
      description:
        'Можливо щось постійно відводить тебе від програмування. Але якщо сфокусуватия правильно - це дуже допомагає більності людей.',
